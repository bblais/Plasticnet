...
/* "splikes\neurons\poisson_julijana.pyx":12
 *     cdef public np.ndarray u
 * 
 *     cpdef _reset(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_f_7splikes_7neurons_16poisson_julijana_16poisson_julijana__reset(struct __pyx_obj_7splikes_7neurons_16poisson_julijana_poisson_julijana *__pyx_v_self, int __pyx_skip_dispatch) {
  ...
  /* "splikes\neurons\poisson_julijana.pyx":13
 * 
 *     cpdef _reset(self):
 *         self.u=np.zeros(self.N,dtype=np.float)             # <<<<<<<<<<<<<<
 *         neuron._reset(self)
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":14
 *     cpdef _reset(self):
 *         self.u=np.zeros(self.N,dtype=np.float)
 *         neuron._reset(self)             # <<<<<<<<<<<<<<
 * 
...
/* "splikes\neurons\poisson_julijana.pyx":16
 *         neuron._reset(self)
 * 
 *     def __init__(self,N):             # <<<<<<<<<<<<<<
...
static int __pyx_pf_7splikes_7neurons_16poisson_julijana_16poisson_julijana_2__init__(struct __pyx_obj_7splikes_7neurons_16poisson_julijana_poisson_julijana *__pyx_v_self, PyObject *__pyx_v_N) {
  ...
  /* "splikes\neurons\poisson_julijana.pyx":17
 * 
 *     def __init__(self,N):
 *         neuron.__init__(self,N)             # <<<<<<<<<<<<<<
 *         self.tau_ex=0.011    #in s, membrane time constant (EPSP timescale)
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":18
 *     def __init__(self,N):
 *         neuron.__init__(self,N)
 *         self.tau_ex=0.011    #in s, membrane time constant (EPSP timescale)             # <<<<<<<<<<<<<<
 *         self.r_0=0.0  # baseline firing rate
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":19
 *         neuron.__init__(self,N)
 *         self.tau_ex=0.011    #in s, membrane time constant (EPSP timescale)
 *         self.r_0=0.0  # baseline firing rate             # <<<<<<<<<<<<<<
 *         self.g_0=10.0
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":20
 *         self.tau_ex=0.011    #in s, membrane time constant (EPSP timescale)
 *         self.r_0=0.0  # baseline firing rate
 *         self.g_0=10.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":22
 *         self.g_0=10.0
 * 
 *         self._reset()             # <<<<<<<<<<<<<<
 * 
...
/* "splikes\neurons\poisson_julijana.pyx":26
 *     @cython.cdivision(True)
...
static PyObject *__pyx_f_7splikes_7neurons_16poisson_julijana_16poisson_julijana_update(struct __pyx_obj_7splikes_7neurons_16poisson_julijana_poisson_julijana *__pyx_v_self, double __pyx_v_t, struct __pyx_obj_7splikes_7splikes_simulation *__pyx_v_sim, int __pyx_skip_dispatch) {
  ...
  /* "splikes\neurons\poisson_julijana.pyx":31
 *         cdef double x
 *         cdef neuron pre
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":32
 *         cdef neuron pre
 *         cdef double *u=<double *>self.u.data
 *         cdef double *rate=<double *>self.rate.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":35
 * 
 *         # quantities decay exponentially
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":36
 *         # quantities decay exponentially
 *         x=-sim.dt/self.tau_ex
 *         for i in range(self.N):             # <<<<<<<<<<<<<<
 *             u[i]*=exp(x)
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "splikes\neurons\poisson_julijana.pyx":37
 *         x=-sim.dt/self.tau_ex
 *         for i in range(self.N):
 *             u[i]*=exp(x)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":42
 ...
 */
  ...
  for (;;) {
    ...
    /* "splikes\neurons\poisson_julijana.pyx":43
 * 
 *         for c in self.connections_pre:
 *             pre=c.pre             # <<<<<<<<<<<<<<
 *             W=c.W
 ...
 */
    ...
    /* "splikes\neurons\poisson_julijana.pyx":44
 *         for c in self.connections_pre:
 *             pre=c.pre
 *             W=c.W             # <<<<<<<<<<<<<<
 *             spiking=<int *>pre.spiking.data
 ...
 */
    ...
    /* "splikes\neurons\poisson_julijana.pyx":45
 *             pre=c.pre
 *             W=c.W
 *             spiking=<int *>pre.spiking.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "splikes\neurons\poisson_julijana.pyx":47
 *             spiking=<int *>pre.spiking.data
 * 
 *             if pre.is_spike:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_13) {
      ...
      /* "splikes\neurons\poisson_julijana.pyx":48
 * 
 *             if pre.is_spike:
 *                 for j in range(pre.N):             # <<<<<<<<<<<<<<
 *                     if spiking[j]:
 ...
 */
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        ...
        /* "splikes\neurons\poisson_julijana.pyx":49
 *             if pre.is_spike:
 *                 for j in range(pre.N):
 *                     if spiking[j]:             # <<<<<<<<<<<<<<
 *                         for i in range(self.N):
 ...
 */
        ...
        if (__pyx_t_13) {
          ...
          /* "splikes\neurons\poisson_julijana.pyx":50
 *                 for j in range(pre.N):
 *                     if spiking[j]:
 *                         for i in range(self.N):             # <<<<<<<<<<<<<<
 *                             u[i]+=W[i*pre.N+j]/self.tau_ex
 ...
 */
          ...
          for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_10; __pyx_t_14+=1) {
            ...
            /* "splikes\neurons\poisson_julijana.pyx":51
 *                     if spiking[j]:
 *                         for i in range(self.N):
 *                             u[i]+=W[i*pre.N+j]/self.tau_ex             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":53
 *                             u[i]+=W[i*pre.N+j]/self.tau_ex
 * 
 *         spiking=<int *>self.spiking.data             # <<<<<<<<<<<<<<
 *         self.is_spike=0
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":54
 * 
 *         spiking=<int *>self.spiking.data
 *         self.is_spike=0             # <<<<<<<<<<<<<<
 *         for i in range(self.N):
 ...
 */
  ...
  /* "splikes\neurons\poisson_julijana.pyx":55
 *         spiking=<int *>self.spiking.data
 *         self.is_spike=0
 *         for i in range(self.N):             # <<<<<<<<<<<<<<
 *             rate[i]=self.r_0+self.g_0*u[i]
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "splikes\neurons\poisson_julijana.pyx":56
 *         self.is_spike=0
 *         for i in range(self.N):
 *             rate[i]=self.r_0+self.g_0*u[i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "splikes\neurons\poisson_julijana.pyx":58
 *             rate[i]=self.r_0+self.g_0*u[i]
 * 
 *             if randu()<(rate[i]*sim.dt):             # <<<<<<<<<<<<<<
 *                 spiking[i]=1
 ...
 */
    ...
    if (__pyx_t_13) {
      ...
      /* "splikes\neurons\poisson_julijana.pyx":59
 * 
 *             if randu()<(rate[i]*sim.dt):
 *                 spiking[i]=1             # <<<<<<<<<<<<<<
 *                 self.is_spike=1
 ...
 */
      ...
      /* "splikes\neurons\poisson_julijana.pyx":60
 *             if randu()<(rate[i]*sim.dt):
 *                 spiking[i]=1
 *                 self.is_spike=1             # <<<<<<<<<<<<<<
 *                 self.post_count+=1
 ...
 */
      ...
      /* "splikes\neurons\poisson_julijana.pyx":61
 *                 spiking[i]=1
 *                 self.is_spike=1
 *                 self.post_count+=1             # <<<<<<<<<<<<<<
 *                 if self.save_spikes_begin<=t<=self.save_spikes_end:
 ...
 */
      ...
      /* "splikes\neurons\poisson_julijana.pyx":62
 *                 self.is_spike=1
 *                 self.post_count+=1
 *                 if self.save_spikes_begin<=t<=self.save_spikes_end:             # <<<<<<<<<<<<<<
 *                     self.saved_spikes.append( (t,i) )
 ...
 */
      ...
      if (__pyx_t_16) {
        ...
        /* "splikes\neurons\poisson_julijana.pyx":63
 *                 self.post_count+=1
 *                 if self.save_spikes_begin<=t<=self.save_spikes_end:
 *                     self.saved_spikes.append( (t,i) )             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "splikes\neurons\poisson_julijana.pyx":65
 *                     self.saved_spikes.append( (t,i) )
 *             else:
 *                 spiking[i]=0             # <<<<<<<<<<<<<<
 */
...
/* "splikes\neurons\poisson_julijana.pyx":10
 * cdef class poisson_julijana(neuron):
 *     cdef public double tau_ex,r_0,g_0
 *     cdef public np.ndarray u             # <<<<<<<<<<<<<<
 * 
