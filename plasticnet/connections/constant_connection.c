...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  __pyx_ptype_10plasticnet_10plasticnet_connection = __Pyx_ImportType("plasticnet.plasticnet", "connection", sizeof(struct __pyx_obj_10plasticnet_10plasticnet_connection), 1); if (unlikely(!__pyx_ptype_10plasticnet_10plasticnet_connection)) __PYX_ERR(2, 1, __pyx_L1_error)
  ...
  if (PyObject_SetAttrString(__pyx_m, "Constant_Connection", (PyObject *)&__pyx_type_10plasticnet_11connections_19constant_connection_Constant_Connection) < 0) __PYX_ERR(2, 8, __pyx_L1_error)
...
static int __pyx_pymod_exec_constant_connection(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init plasticnet.connections.constant_connection", 0, __pyx_lineno, __pyx_filename);
    }
